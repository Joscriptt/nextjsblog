...
<div className="flex justify-between items-center text-gray-200">
   ...
   <div className="flex my-2">
    <p className="text-sm font-BeVietnamProReg  py-3 ">Enter your login details</p>
<img className="w-9 h-9" src="/images/secret.webp" alt="" />
    ...
    <form onSubmit={registerUser} className="bg-slate-50 p-3 rounded-b-lg">
      ...
      <input
       ...
       value={user.password}
       onChange={handleChange}
       className="bg-[#0e5e5f] focus:outline-none rounded-lg p-2" type="password" placeholder="Enter password"  />
      </div>
