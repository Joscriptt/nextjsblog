...
<div className="flex justify-between items-center text-gray-200">
   ...
   <div className="flex my-2">
    <p className="text-sm font-BeVietnamProReg  py-3 ">Register for an account</p>
<img className="w-9 h-9" src="/images/secret.webp" alt="" />
    ...
    <button className="text-xs " onClick={()=>signIn("google")}>Register with Google</button>
    </div>
    <div className="p-1 border border-gray-300/40 px-3 rounded-xl bg-white/10 w-fit flex gap-2 items-center">
    ...
    <form onSubmit={registerUser} className="bg-slate-50 p-3 rounded-b-lg">
      <div className="flex flex-col">
      <label className="mb-2" htmlFor="email">Username</label>
      <input className="bg-[#0e5e5f] rounded-lg p-2  focus:outline-none" 
       name="username"
       value={user.username}
      ...
      <input
       ...
       value={user.password}
       onChange={handleChange}
       className="bg-[#0e5e5f] focus:outline-none rounded-lg p-2" type="password" placeholder="Enter email address"  />
      </div>
