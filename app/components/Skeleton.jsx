  ...
  return (
    ...
    <div className="lg:flex gap-4  ">
      <div className="w-[500px]">
        <div>
          <div className="relative space-y-5 overflow-hidden rounded-2xl  p-4 shadow-xl shadow-black/5 before:absolute before:inset-0 before:-translate-x-full before:animate-[shimmer_2s_infinite] before:border-t before:border-gray-100/10 before:bg-gradient-to-r before:from-transparent before:via-gray-100 before:to-transparent">
